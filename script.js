...
function init() {
  ...
  function createActionButtons(game) {
    const playstationUrl = game.stores.playstation.id
    ...
    ${
      game.stores.steam
        ? `<button class="action-btn steam-btn" onclick="window.open('https://store.steampowered.com/app/${game.stores.steam}', '_blank')" title="Steam"><i class="fab fa-steam"></i></button>`
        : ""
    }
    ${
      playstationUrl
    ...
    ${
      game.stores.xbox
        ? `<button class="action-btn xbox-btn" onclick="window.open('https://www.xbox.com/en-us/games/store/${game.stores.xbox}', '_blank')" title="Xbox Store"><i class="fab fa-xbox"></i></button>`
        : ""
    }
    ${
      game.stores.googlePlay
        ? `<button class="action-btn google-btn" onclick="window.open('https://play.google.com/store/apps/details?id=${game.stores.googlePlay}', '_blank')" title="Google PlayStore"><i class="fab fa-google-play"></i></button>`
        : ""
    }
    ${
      game.stores.epicGames
        ? `<button class="action-btn epic-btn" onclick="window.open('https://store.epicgames.com/en-US/p/${game.stores.epicGames}', '_blank')" title="Epic Games">
    ...
    ${
      game.stores.humble
        ? `<button class="action-btn humble-btn" onclick="window.open('https://www.humblebundle.com/store/${game.stores.humble}', '_blank')" title="Humble Bundle">
    ...
    ${
      game.stores.itch
        ? `<button class="action-btn itch-btn" onclick="window.open('https://${game.stores.itch}.itch.io', '_blank')" title="itch.io"><i class="fab fa-itch-io"></i></button>`
        : ""
    }
    ${
      game.stores.gog
        ? `<button class="action-btn gog-btn" onclick="window.open('https://www.gog.com/game/${game.stores.gog}', '_blank')" title="GOG.com">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="vertical-align:middle;">
    ...
    ${
      game.stores.origin
        ? `<button class="action-btn origin-btn" onclick="window.open('https://www.origin.com/store/${game.stores.origin}', '_blank')" title="Origin">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" style="vertical-align:middle;">
              <rect width="24" height="24" rx="4" fill="#f05622"/>
              <text x="12" y="16" text-anchor="middle" font-size="10" fill="#fff" font-family="Arial, sans-serif">O</text>
            </svg>
          </button>`
        : ""
    }
